...
public class SkyfishMediaEndpoint {
    ...
    /// <param name="id">The ID of the media.</param>
    /// <returns>An instance of <see cref="SkyfishMediaTagsResponse"/> representing the response.</returns>
    public async Task<SkyfishMediaTagsResponse> GetTagsAsync(int id) {
        return new SkyfishMediaTagsResponse(await Raw.GetTagsAsync(id));
    }
    ...
    /// <param name="options">The options for the request to the API.</param>
    /// <returns>An instance of <see cref="SkyfishMediaTagsResponse"/> representing the response.</returns>
    public async Task<SkyfishMediaTagsResponse> GetTagsAsync(SkyfishGetMediaTagsOptions options) {
        return new SkyfishMediaTagsResponse(await Raw.GetTagsAsync(options));
    }
    ...
    /// response, but with an empty stream URL.
    /// </remarks>
    public async Task<SkyfishMediaStreamUrlResponse> GetStreamUrlAsync(int uniqueMediaId) {
        return new SkyfishMediaStreamUrlResponse(await Raw.GetStreamUrlAsync(uniqueMediaId));
    }
    ...
    /// <see cref="HttpStatusCode.Conflict"/> response.
    /// </remarks>
    public async Task<SkyfishResponse> CreateStreamAsync(int uniqueMediaId) {
        return new SkyfishResponse(await Raw.CreateStreamAsync(uniqueMediaId));
    }
