...
namespace Limbo.Integrations.Skyfish.Models.Folders {
    ...
    /// <summary>
    /// Class representing a Skyfish folder.
    /// </summary>
    public class SkyfishFolder : JsonObjectBase {
        ...
        protected SkyfishFolder(JObject json) : base(json) {
            Id = json.GetInt32("id");
        ...
        /// <summary>
        /// Initializes a new instance of <see cref="SkyfishFolder"/> based on the specified <paramref name="json"/> object.
        /// </summary>
        /// <param name="json">The JSON object representing the folder.</param>
        /// <returns>An instance of <see cref="SkyfishFolder"/>.</returns>
        [return: NotNullIfNotNull("json")]
        public static SkyfishFolder? Parse(JObject? json) {
            return json == null ? null : new SkyfishFolder(json);
        }
